...
const App = () => {
  ...
  const renderNotConnectedContainer = () => (
    <div className="connect-wallet-container">
      <img
        src="http://www.reactiongifs.com/r/cheering_minions.gif"
        alt="Sebel gif"
        style={{ maxWidth: "calc(100vw - 50px)", borderRadius: "8px" }}
      />
    ...
    return (
      <div className="form-container">
        ...
        <input
          type="text"
          value={record}
          placeholder="whats ur sebel power?"
    ...
    <div className="App">
      <div className="container">
        <div className="header-container">
          <header>
            <div className="left">
              <p className="title">🐱 Sebel Name Service</p>
